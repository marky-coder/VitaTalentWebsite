    ...
    <section className="py-24" data-testid="section-workflow">
      <div className="container max-w-7xl mx-auto px-4">
        ...
        <div className="hidden md:grid grid-cols-5 gap-6">
          {steps.map((step, index) => (
            <div key={step.number} className="relative">
              <Card className="p-6 text-center h-full hover-elevate" data-testid={`card-step-${step.number}`}>
        ...
        <div className="md:hidden space-y-4">
          {steps.map((step) => (
            <Card key={step.number} className="p-6" data-testid={`card-step-mobile-${step.number}`}>
