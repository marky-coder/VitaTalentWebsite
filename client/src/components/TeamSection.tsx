...
const team: TeamMember[] = [
  ...
  { name: "Mohamed Ayman", role: "President", initials: "MA", image: mohamedAymanImage },
  { name: "Mo Alaa", role: "COO", initials: "MA", image: moAlaaImage, imageScale: "scale-125 object-top" },
  { name: "Hannah Alaa", role: "Social Media Manager", initials: "HA", image: hanaAboubakrImage, imageScale: "scale-125 object-center" },
  { name: "Mark Anthony", role: "Automation Expert", initials: "MA", image: markAnthonyImage, imageScale: "scale-[1.2] object-center" },
  { name: "Ivy Baker", role: "Recruiter", initials: "IB", image: ivyBakerImage, imageScale: "scale-100 object-center" },
  { name: "Lina Hossam", role: "Recruiter", initials: "LH", image: linaHossamImage, imageScale: "scale-125 object-center" },
];
      ...
      <div className="container max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-8 max-w-5xl mx-auto">
          {team.map((member, index) => {
            ...
            /* For Nathaniel: add both the rotating neon class and the static border fallback */
            const cardClasses = `${isNathaniel ? `${neonStyles.neonCard} ${neonStyles.staticBorder}` : ""} group w-full sm:w-1/2 md:w-1/3 lg:w-1/4 max-w-xs overflow-hidden bg-gradient-to-br from-card via-card to-primary/8 border border-primary/20 shadow-md hover:shadow-2xl hover:border-primary/40 transition-all duration-500 hover:-translate-y-1`;

            /* Footer: set to white for Nathaniel */
            ...
            const nameClass = "font-semibold text-base text-foreground tracking-tight transition-colors duration-300 mb-1";
            const roleClassDefault = "text-sm font-medium text-muted-foreground";
            const roleClassNathan = "text-sm font-medium text-gray-700";
              ...
              >
                <div className="flex flex-col h-full">
                  ...
                  <div className="relative w-full aspect-[3/4] overflow-hidden bg-gradient-to-br from-muted to-muted/50">
                    {member.image ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary/10 to-primary/5">
                        <span className="text-4xl font-bold text-primary/60">{member.initials}</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className={footerClass}>
                    ...
                    <p className={isNathaniel ? roleClassNathan : roleClassDefault}>
