...
export const roles: RoleData[] = [
  {
    ...
    regions: [
      ...
      },
      {
        ...
        salary: 1100,
        why: [
          "A growing talent pool for sales support and customer-facing roles.",
          "Strong value for teams that want affordability with structured communication support.",
          "Useful for businesses building efficient outbound support functions.",
        ],
      },
    ],
  ...
  },
  {
    ...
    regions: [
      ...
      },
      {
        ...
        salary: 1200,
        why: [
          "A growing market for organized support and scheduling roles.",
          "Strong option for cost-conscious teams that still want dedicated follow-up support.",
          "Useful for businesses building a structured appointment-setting function.",
        ],
      },
    ],
  ...
  },
  {
    ...
    regions: [
      ...
      },
      {
        ...
        salary: 1700,
        why: [
          "A growing option for companies wanting capable sales support at efficient rates.",
          "Useful for teams that need structured deal follow-up and pipeline discipline.",
          "Strong value for businesses balancing affordability with revenue support.",
        ],
      },
    ],
  ...
  },
  {
    ...
    regions: [
      ...
      },
      {
        ...
        salary: 1750,
        why: [
          "A strong value option for organized post-contract support.",
          "Useful for businesses that want reliable buyer communication and process tracking.",
          "Good fit for teams building more structure after the deal is secured.",
        ],
      },
    ],
  ...
  },
  {
    ...
    regions: [
      ...
      },
      {
        ...
        salary: 1400,
        why: [
          "A growing option for process-heavy coordination and admin support.",
          "Useful for teams that want structure, documentation, and deadline tracking.",
          "Strong value for businesses that need more back-office consistency.",
        ],
      },
    ],
  ...
  },
  {
    ...
    regions: [
      ...
      },
      {
        ...
        salary: 1400,
        why: [
          "A practical option for businesses that want dedicated lead organization support.",
          "Good fit for structured communication and front-end pipeline management.",
          "Strong value for teams improving follow-up discipline.",
        ],
      },
    ],
  ...
  },
  {
    ...
    regions: [
      ...
      },
      {
        ...
        salary: 1350,
        why: [
          "A growing market for organized admin and executive support.",
          "Useful for leaders who want dependable support at efficient rates.",
          "Good fit for recurring operational and coordination tasks.",
        ],
      },
    ],
  ...
  },
  {
    ...
    regions: [
      ...
      },
      {
        ...
        salary: 2200,
        why: [
          "A cost-efficient option for businesses expanding paid acquisition support.",
          "Useful for structured campaign management and reporting needs.",
          "Good fit for teams that want marketing execution support without overspending.",
        ],
      },
    ],
  ...
  },
  {
    ...
    regions: [
      ...
      },
      {
        ...
        salary: 1700,
        why: [
          "A growing option for design support and branded asset production.",
          "Useful for businesses that need steady creative bandwidth at efficient rates.",
          "Good fit for teams balancing design quality with cost control.",
        ],
      },
    ],
  ...
  },
  {
    ...
    regions: [
      ...
      },
      {
        ...
        salary: 1450,
        why: [
          "A useful option for businesses building consistent editing capacity.",
          "Strong value for teams producing branded and short-form content.",
          "Good fit for companies that want efficient creative support.",
        ],
      },
    ],
  ...
  },
  {
    ...
    regions: [
      ...
      },
      {
        ...
        salary: 1550,
        why: [
          "A growing option for structured systems and workflow support.",
          "Strong value for businesses improving internal processes without heavy overhead.",
          "Useful for companies wanting technical help with better cost efficiency.",
        ],
      },
    ],
